...
- Name: e2e\alumnos.spec.ts >> Gestión de Alumnos >> Debería permitir registrar un alumno en Clase de Prueba
- Location: tests\e2e\alumnos.spec.ts:85:7
...
Locator: locator('p:has-text("Prueba E2E 8077")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('p:has-text("Prueba E2E 8077")')
...
- main:
  ...
  - paragraph: Completá los datos personales.
  - text: ↵ Enter para navegación rápida
  - button "Cerrar"
  - text: Nombre completo *
  - 'textbox "Ej: Juan García"': Prueba E2E 8077
  - text: DNI *
  - 'textbox "Ej: 38765432"': "98288251"
  - text: Nacimiento *
  - textbox: 2000-01-01
  - text: Registro *
  - textbox: 2026-06-15
  - text: Teléfono *
  - 'textbox "Ej: 11-4521-0011"': "1188223344"
  - text: Género *
  - combobox:
    - option "Seleccionar..."
    - option "Masculino"
    - option "Femenino" [selected]
  - text: Dirección *
  - 'textbox "Ej: Av. Corrientes 1234"'
  - text: La dirección es requerida Email
  - 'textbox "Ej: juan@gmail.com"'
  - text: Contacto de Emergencia *
  - 'textbox "Ej: 11-4521-0012 (Mamá)"'
  - text: El contacto de emergencia es requerido Observaciones (Opcional)
  - 'textbox "Ej: Alergia al polvo, lesión en rodilla derecha"'
  - button "Guardar y Registrar Cobro"
  - button "Cancelar"
  - button "Guardar Datos Alumnos"
  - heading "Alumnos" [level=1]
  - paragraph: 0 alumnos registrados · ordenados por orden de entrada
  - button "Crear Alumno"
  ...
  - text: Pág. 1/1
  - paragraph: 0 resultados para “98288251”
