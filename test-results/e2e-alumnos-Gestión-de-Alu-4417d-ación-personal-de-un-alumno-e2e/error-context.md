...
- Name: e2e\alumnos.spec.ts >> Gestión de Alumnos >> Debería permitir editar la información personal de un alumno
- Location: tests\e2e\alumnos.spec.ts:50:7
...
Locator: locator('p:has-text("Test Alumno E2E 7290")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('p:has-text("Test Alumno E2E 7290")')
...
- main:
  ...
  - text: Pág. 1/1
  - paragraph: 0 resultados para “99992284”
